+++
title = "Cómo podríamos pensar el software"
subtitle = "Actas apócrifas sobre una cultura de software alternativa"
...
summary = "Actas ficticias de una visita a Atelier, un taller de otra dimensión donde el software se diseña como un medio compartido para pensar: comportamiento visible, teoría distribuida y gobernanza legible."
background = "as-we-may-think-software-portal.jpg"
backgroundSummary = "as-we-may-think-software-portal.jpg"
url = "/thoughts/2026/01/as-we-may-think-software/"
+++
...
<p style="text-align: center;"><strong>Cruzar. Observar. Tomar actas.</strong></p>
...
{{<figure src="/images/thoughts/as-we-may-think-software-workshop.jpg" width="60%" alt="El taller de Atelier: mesas grandes con objetos cotidianos que responden con luz, texto y movimiento">}}
...
—Bienvenidos —dijo—. Soy [Adele](https://es.wikipedia.org/wiki/Adele_Goldberg) [Engelbart](https://es.wikipedia.org/wiki/Douglas_Engelbart).
...
{{<figure src="/images/thoughts/as-we-may-think-software-wall.jpg" width="60%" alt="La pared blanca proyecta las dos definiciones incompatibles de «entregado»">}}
...
{{<figure src="/images/thoughts/as-we-may-think-software-table.jpg" width="60%" alt="La mesa del taller como superficie de simulación continua del dominio">}}
...
{{<figure src="/images/thoughts/as-we-may-think-software-manifesto.jpg" width="60%" alt="El manifiesto del taller: cuatro líneas escritas a mano en la pared">}}
...
<p style="text-align: center;"><strong>Lo que creemos</strong> &nbsp;&nbsp;&nbsp;&nbsp; <strong>Lo que vimos</strong></p>
...
[^1]: Petricek, T. (2021). [*Software designers, not engineers: An interview from alternative universe*](https://tomasp.net/blog/2021/software-designers/). Blog de Tomas Petricek.
...
[^4]: Ingalls, D. (1981). [*Design Principles Behind Smalltalk*](https://worrydream.com/refs/Ingalls_1981_-_Design_Principles_Behind_Smalltalk.pdf). BYTE Magazine, agosto de 1981.
[^5]: Kay, A. (1977). [*Personal Dynamic Media*](/thoughts/refs/Kay1977.pdf). IEEE Computer, 10(3), 31–41. https://doi.org/10.1109/C-M.1977.217672
[^6]: [*Constructionism (learning theory)*](https://en.wikipedia.org/wiki/Constructionism_%28learning_theory%29). Wikipedia.
